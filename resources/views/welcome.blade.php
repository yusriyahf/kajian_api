...
<div class="row">
  ...
  <script>
      ...
      const salesData = @json($groupedSales);

      // Menyiapkan data untuk chart
      const labels = Object.keys(salesData); // Bulan
      const data = Object.values(salesData); // Total price per bulan
