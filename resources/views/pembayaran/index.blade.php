    ...
    <div class="col-lg-12 d-flex align-items-stretch">
        <div class="card w-100">
            <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4 text-primary">Daftar Pembayaran</h5>
                    ...
                    <table class="table table-bordered text-nowrap mb-0 align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0">
                                    <h6 class="fw-semibold mb-0">{{ $d->user->first_name }} {{ $d->user->last_name }}</h6>
                                </td>
                                <td class="border-bottom-0">
                                ...
                                <td class="border-bottom-0">
                                    <p class="mb-0 fw-normal">{{ $d->status }}</p>
                                </td>
                                <td class="border-bottom-0">
                                    <p class="mb-0 fw-normal">{{ $d->kajian->price }}</p>
                                </td>
